  ...
  <div className="bg-white py-12 sm:p-0">
    <div className="max-w-screen-xl m-auto sm:p-24">
      <div className="bg-gray-100 flex-col md:flex-row flex justify-center items-stretch">
        <div className="h-64 md:h-auto relative md:w-6/12 lg:-translate-x-16  lg:-translate-y-16">
      ...
      <div className="bg-gray-100 flex-col md:flex-row flex justify-center items-stretch">
        <div className="h-64 md:h-auto md:w-6/12 order-first md:order-1 lg:translate-x-16 relative lg:translate-y-16">
