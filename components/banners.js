  ...
  return (
    <Carousel>
      {banners.map(({ data, id }) => {
        return (
          <div
            className="relative flex md:flex-row flex-col min-h-screen"
            key={id}
          >
            <Img
              ...
              css={{ minHeight: '70vh' }}
            />
            <div className="flex flex-col items-start md:items-stretch md:w-5/12 lg:w-4/12 bg-white border-l-8 border-gray-100 py-12 px-12 justify-end text-black">
