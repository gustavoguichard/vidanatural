...
const Notifications = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-end w-full gap-4">
        {notifications
      ...
      <div className="relative flex flex-col-reverse items-start w-full gap-4">
        {notifications
      ...
      <div className="relative flex flex-col-reverse items-end w-full gap-4">
        {notifications
