...
const DiscountTag = ({ product, small, ...props }) => {
  ...
  return product.discount_rule ? (
    <div
      className={cx(
        'absolute flex justify-center items-center p-2 z-20 bg-white border border-gray-200 rounded tracking-tight font-semibold text-center leading-none top-0 right-0',
        small
