...
function TermsAndConditions() {
  ...
  return (
    <div>
      <div className="max-w-screen-sm m-auto prose prose-secondary">
        <div className="px-10">
        ...
        <p>
          ...
          Este cálculo leva em conta o local de entrega (CEP), valor do pedido,
          peso e cubagem dos produtos.
        </p>
        <p>
          ...
          postagem; e SEDEX (encomenda expressa), com prazo de entrega médio de
          48 horas para capitais e 72 horas para Interior, após postagem
          mediante confirmação do pedido. Os Correios oferecem cobertura de
          entrega em todo o território nacional por PAC e nas principais cidades
          por SEDEX.
        </p>
        <Img
        ...
        <p>
          ...
          internautas que fazem compras na sua loja online. Os dados cadastrados
          no site como nome, endereço, e-mail e telefone são protegidos e
          mantidos em sigilo em nossos servidores. Os dados utilizados para o
          pagamento, especialmente Cartão de Crédito, são utilizados apenas no
          ato da compra{' '}
        ...
        <p>
          ...
          meios e medidas técnicas ao seu alcance para evitar a perda, mau uso,
          alteração, acesso não autorizado ou subtração indevida dos dados
          pessoais recolhidos. Não obstante, o usuário deve estar ciente que as
          medidas de segurança relativas à Internet não são integralmente
          infalíveis.
        </p>
        <p>
          A Vida Natural se reserva ao direito de modificar a presente política
          para adaptá-la a alterações legislativas ou jurisprudências, ou
          aquelas relativas às práticas comerciais. Em qualquer caso, a Vida
          Natural anunciará no site por meio desta página as mudanças
          introduzidas com uma antecedência razoável à sua colocação em prática.
          A Vida Natural se preocupa com a privacidade das informações de seus
          clientes.
          <br />
        ...
        <p>
          ...
          fornecer os seus dados pessoais requeridos na contratação, atualização
          ou cancelamento de determinados serviços oferecidos no site ou através
          dele, tais como: promoções, compras na loja virtual, contatos com os
          serviços de atendimento e outros.
        </p>
        <p>
          ...
          identificar: o público, usuário, seu perfil e hábitos de compra, para
          gestão, administração, atendimento, ampliação e melhorias nos produtos
          e serviços oferecidos; e também para a adequação dos serviços às
          preferências e gostos dos usuários; para a criação de novos produtos e
          serviços; para o envio de informações operacionais e comerciais
          relativas aos produtos e serviços, por meios tradicionais e/ou
          eletrônico.
        </p>
        <Img
          className="mx-auto mt-20 mb-10 text-center"
        ...
        <p>
          Os produtos comercializados na loja online da Vida Natural possuem 90
          dias de garantia em caso de falhas naturais de fabricação. Estamos à
          disposição para orientações na utilização de sua garantia, através do
          Serviço de Atendimento ao Consumidor.
        </p>
        <p>
          <strong>
            As ocorrências que envolvam troca ou devolução devem ser comunicadas
            a nossa Central de Atendimento através do email:
        ...
        <ul>
          ...
          <li>
            O produto deve ser devolvido na embalagem original, sem indícios de
            uso, acompanhado da Nota Fiscal e todos os acessórios.
          </li>
          <li>
        ...
        <ul>
          <li>
            Para devolução ou troca por motivos de insatisfação, a Vida Natural
            se reserva o direito de cobrança das despesas de frete bem como
            outras despesas associadas à sua devolução.
          </li>
        </ul>
        <p className="font-semibold translate-y-2">
        ...
        <p className="font-semibold translate-y-2">
          A Restituição de Valores, caso o produto atenda às exigências acima, a
          restituição do valor pago será conforme as opções de pagamento abaixo:
        </p>
        <ul>
          <li>
