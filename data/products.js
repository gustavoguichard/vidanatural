export default [
  ...
  {
    name: 'Xampú em Barra',
    fullName: 'Xampú Cheiro Natural 100g',
    subtitle: 'Limpa sem remover a hidratação natural.',
    path: 'xampu-em-barra-natural',
    packing: 'barra',
    tone: '#0b0c17',
    size: 6,
    showHome: false,
  ...
  },
  {
    ...
    ingredients: ['Rosa Canina Fruit Oil', 'Lavandula Angustifolia Extract'],
    benefits: [
