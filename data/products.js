...
`,
    ...
    characteristics: [
      ['Gênero', 'Sem gênero'],
      ['Peso líquido', '40g'],
      ['Tipo de embalagem', 'Pote de vidro'],
      ['Fragrância', 'Lavanda e Melaleuca (Tea Tree)'],
      ['Vegano', 'Sim'],
      ['Antitranspirante', 'Não'],
      ['Dimensões (L x C x A)', '6 x 6 x 6 cm'],
      ['Validade', '1 ano'],
      ['Rendimento médio', '100 aplicações (mais de 3 meses)'],
      ['Regulado pela ANVISA sob nº', '4.00.537-0'],
      ['Notificação Anvisa', '25351.336158/2019-84'],
      ['Código de barras', '0606529335502'],
    ],
  },
  {
    vndaId: 1,
